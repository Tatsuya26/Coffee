    ...
    override fun onCreate() {
        ...
        runBlocking {
            repository.insertCafe(Cafe(
                        ...
                        Contacto("+351253262336"), Horario(9,0,2,0),"java/edu/um/coffe/menu/cafevianna.png")
                    )
            /*
            repository.insertCafe(Cafe(
